...
def test_crear_reserva_falla_no_organizador(client, usuario_comun_activo, cancha_creada):
...
def test_crear_reserva_falla_pasada(client, organizador_activo, cancha_creada):
...
def test_crear_reserva_exitosa(client, organizador_activo, cancha_creada):
...
def test_reprogramar_falla_ocupado(client, organizador_activo, cancha_creada):
...
def test_reprogramar_exitoso(client, organizador_activo, cancha_creada):
...
def test_obtener_agenda(client, organizador_activo, cancha_creada):
...
def test_cancelar_reserva_falla_pasada(client, organizador_activo, cancha_creada, db_session):
...
def test_cancelar_reserva_exitosa(client, organizador_activo, cancha_creada):
